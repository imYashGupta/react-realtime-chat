...
$(function() {
    var e = {
        Started: {
            ...
            scrolllRun: function(e) {
                ...
                if (0 < o.length)
                    if (1200 <= $(window).width()) {
                        ...
                        o.scrollTop(o.get(0).scrollHeight, -1).niceScroll(a),
                        $(".layout .content .sidebar .sidebar-body").niceScroll(a),
                        e && (o.scrollTop(o.get(0).scrollHeight, -1).getNiceScroll().resize(),
            ...
            init: function() {
                ...
                feather.replace(),
                $(window).width() < 768 && $(".layout .content .sidebar-group .sidebar .list-group-item .users-list-body .users-list-action").removeClass("action-toggle")
            }
        }
    };
    ...
    $(document).on("click", "[data-navigation-target]", function() {
        ...
        o.addClass("show"),
        $(window).width() < 992 ? ($("header.main-header .header-nav").removeClass("open"),
        $(".body-plate").hide()) : $(".body-plate").show(),
